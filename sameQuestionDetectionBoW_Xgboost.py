...
count_vect.fit(pd.concat((train_data[QUESTION_1_COLUMN], train_data[QUESTION_2_COLUMN])).unique())

trainq1_trans = count_vect.transform(train_data[QUESTION_1_COLUMN].values)
trainq2_trans = count_vect.transform(train_data[QUESTION_2_COLUMN].values)
...
testq1_trans = count_vect.transform(test_data['Question1'].values)
testq2_trans = count_vect.transform(test_data['Question2'].values)
